                        ...
                        if(req.body.row == 1){
                            if(cellar.floor1.is_smart_mode == true){
                                ...
                                if(cellar.floor1.cell_ids.length != 0){
                                    cellar.floor1.temperature_target = Math.round(cell_temp_sum[0] / cellar.floor1.cell_ids.length)
                                }
                            }
                        }
                        else if(req.body.row == 2){
                            if(cellar.floor2.is_smart_mode == true){
                                ...
                                if(cellar.floor2.cell_ids.length != 0){
                                    cellar.floor2.temperature_target = Math.round(cell_temp_sum[1] / cellar.floor2.cell_ids.length)
                                }
                            }
                        }
                        else if(req.body.row == 3){
                            if(cellar.floor3.is_smart_mode == true){
                                ...
                                if(cellar.floor3.cell_ids.length != 0){
                                    cellar.floor3.temperature_target = Math.round(cell_temp_sum[2] / cellar.floor3.cell_ids.length)
                                }
                            }
                        }
                    }
                            ...
                            if(req.body.row == 1){
                                ...
                                if(cellar.floor2.is_smart_mode == true){
                                    ...
                                    if(cellar.floor2.cell_ids.length != 0){
                                        ...
                                        console.log(Math.round(cell_temp_sum[1] / cellar.floor2.cell_ids.length));
                                        cellar.floor2.temperature_target = Math.round(cell_temp_sum[1] / cellar.floor2.cell_ids.length)
                                    }
                                }
                            }
        ...
        .post(function(req, res){
            ...
            Cellar.findOne({_id: req.body.cellarid})
                ...
                .then(function(cellar){
                    ...
                    if(cellar.floor1.is_smart_mode == true && cellar.floor1.cell_ids.length != 0 && !(cellar.reserved_row == 1 && cellar.is_reserved == true)){
                        var temp = 0;
                        ...
                        cellar.floor1.temperature_target = Math.round(temp);
                    }
                    else{
                    ...
                    if(cellar.floor2.is_smart_mode == true && cellar.floor2.cell_ids.length != 0 && !(cellar.reserved_row == 2 && cellar.is_reserved == true)){
                        var temp = 0;
                        ...
                        cellar.floor2.temperature_target = Math.round(temp);
                    }
                    else{
                    ...
                    if(cellar.floor3.is_smart_mode == true && cellar.floor3.cell_ids.length != 0 && !(cellar.reserved_row == 3 && cellar.is_reserved == true)){
                        var temp = 0;
                        ...
                        cellar.floor3.temperature_target = Math.round(temp);
                    }
                    else{
                    ...
                    Cellar.findOne({_id: req.body.cellarid})
                        ...
                        .then(async function(cellar){
                            ...
                            for (const wine of req.body.move_wine){
                                ...
                                console.log("wine pulled");
                                await Cell.create({
                                    row: wine.next_row,
                                    col: wine.next_col,
                                    wine_id: wine_id
                                })
                                    .then(async function(cell1){
                                        console.log("cell created");
                                        console.log(cell1);
                                        if(wine.next_row == 1){
                                            console.log("fdfdfdfdfdf");
                                            console.log(wine);
                                            cellar.floor1.cell_ids.push(cell1._id);
                                        }
                                        // floor 2
                                        else if(wine.next_row == 2){
                                            cellar.floor2.cell_ids.push(cell1._id);
                                        }
                                        // floor 3
                                        else if(wine.next_row == 3){
                                            cellar.floor3.cell_ids.push(cell1._id);
                                        }
        ...
        if(same_cate_arr.length != 0){
            ...
            for(var i = 0; i < same_cate_arr.length; i++){
                if(diff > Math.abs(cur_cellar_temp[same_cate_arr[i]] - input_wine_temp)){
                    ...
                    input_wine_floor = same_cate_arr[i];
                }
            }
            ...
            for(var i = 0; i < 3; i++){
                if(is_smart_arr[i] == 0){ // 스마트 모드가 꺼진 칸에서
                    if(cur_cellar_count[i] != 5){ // 그 칸에서 빈 것이 있는 경우
                        for(var j = 0; j < 5; j++){ 
                            if(wine_cellar[i * 5 + j] == -1){
                                next_temp = Math.round((cur_cellar_temp[i] * cur_cellar_count[i] + input_wine_temp) / (cur_cellar_count[i] + 1));
                                jsonData.input_row = i + 1;
            ...
            if(not_this_cate.length == 1){
                ...
                console.log("not_this_cate.length != 1");
                ...
                if((is_smart_arr[not_this_cate[0]] == 1) && (is_smart_arr[not_this_cate[1]] == 1)){
                    console.log("is_smart_arr[not_this_cate[0]] == 1 && is_smart_arr[not_this_cate[1]] == 1");
                    if(wine_categories[not_this_cate[0]] == wine_categories[not_this_cate[1]]){
                        if((cur_cellar_count[not_this_cate[0]] + cur_cellar_count[not_this_cate[1]]) <= 5){
                            if(cur_cellar_count[not_this_cate[0]] >= cur_cellar_count[not_this_cate[1]]){
                                        ...
                                        for(var p = 0; p < 5; p++){
                                            if(wine_cellar[not_this_cate[0] * 5 + p] == -1){
                                                ...
                                                jsonData.move_wine.push({
                                                    ...
                                                    "next_col" : p + 1,
                                                    "img_src" : wine_img_src[not_this_cate[1] * 5 + q],
                                                    "wine_name" : wine_name_arr[not_this_cate[1] * 5 + q]
                                                })
                                                console.log("not_this_cate[1] 층에 q번째에 해당 와인을 not_this_cate[0] 층에 p번째에 넣기");
                                                break;
                                            }
                                        }
                                    }
                                ...
                                console.log("not_this_cate[1] 층에 1번째에 해당 와인 넣기, 그 층의 온도는 input_temp로 바꾸기, 카테고리도 바꾸고 스마트모드도 켜주기7");
                                jsonData.flag = 2;
                                ...
                                for(var i = 0; i < 3; i++){
                                    ...
                                    console.log("cur_cellar_count[i] : " + cur_cellar_count[i]);
                                    if(cur_cellar_count[i] != 0){
                                        cur_cellar_temp[i] = Math.round(cur_cellar_temp[i] / cur_cellar_count[i]);
                                        console.log("cur_cellar_temp[i] : " + cur_cellar_temp[i]);
                                    }
                                }
                                        ...
                                        for(var p = 0; p < 5; p++){
                                            if(wine_cellar[not_this_cate[1] * 5 + p] == -1){
                                                ...
                                                jsonData.move_wine.push({
                                                    ...
                                                    "next_col" : p + 1,
                                                    "img_src" : wine_img_src[not_this_cate[0] * 5 + q],
                                                    "wine_name" : wine_name_arr[not_this_cate[0] * 5 + q]
                                                })
                                                break;
                                            }
                                        }
